...
class Nodo {
public:
    string nombre;  //string que identifica cada Nodo
    bool seleccionado; // booleano que indica si el nodo está seleccionado o no

    // Constructor por defecto
    Nodo() : nombre(""), seleccionado(false) {}

    // Constructor que recibe un nombre para inicializar el nodo.
    Nodo(string n) : nombre(n), seleccionado(false) {}

    // Método para seleccionar el nodo
    //Cambia el estado del nodo a seleccionado e imprime un mensaje.
    void seleccionar() {
        seleccionado = true;
        separador();
    ...
    //Cambia el estado del nodo a no seleccionado e imprime un mensaje.
    void deseleccionar() {
        seleccionado = false;
        separador();
...
//toma un evento("seleccionar" o "deseleccionar"), el nodo afectado, y devuelve una función de callback
//que se encargará de ejecutar la acción correspondiente sobre el nodo.
...
//Crea un mapa de nodos, y permite al usuario seleccionar o deseleccionar nodos
